...
result setOpeningAlarm(eventMask e){
  ...
  if(e==exitEvent){
    ...
    Serial.println(Clock.readControlByte(false), BIN);
...
TOGGLE(dailySameVar,dailySame,"Gleich: ",toggleDaily,noEvent,noStyle//,doExit,enterEvent,noStyle
  ,VALUE("Ja",1,toggleDaily,noEvent)
  ,VALUE("Nein",0,toggleDaily,noEvent)
);
...
CHOOSE(chooseClosingModeVar,chooseClosingMode,"Modus",doNothing,noEvent,noStyle
  ,VALUE("Tages-Modus",1,doNothing,enterEvent)
  ,VALUE("Wochenende-Modus",2,doNothing,enterEvent)
  ,VALUE("Immer gleich",-1,doNothing,noEvent)
);
...
altMENU(menu, timeMenu, "", setClockTime, anyEvent, noStyle, (systemStyles)(_asPad|_canNav|_menuData|_parentDraw)
  ,FIELD(Hour,"",":",0,23,1,0,doNothing, noEvent, wrapStyle)
  ,FIELD(Minute,"",":",0,59,10,1,doNothing, noEvent, wrapStyle)
  ,FIELD(Second,"", "", 0, 59, 10, 1, doNothing, noEvent, wrapStyle)
);

altMENU(menu, dateMenu, "", setClockDate, anyEvent, noStyle, (systemStyles)(_asPad|_canNav|_menuData|_parentDraw)
  ,FIELD(Date,"",".",0,31,1,0,doNothing, noEvent, noStyle)
  ,FIELD(Month,"",".",0,12,1,0,doNothing, noEvent, noStyle)
  ,FIELD(Year,"","",0,99,1,0,doNothing, noEvent, noStyle)
);

altMENU(menu, openingAlarmMenu, "", setOpeningAlarm, anyEvent, noStyle, (systemStyles)(_asPad|_canNav|_menuData|_parentDraw)
  ,FIELD(openingAlarms[0].hour,"",":",0,23,1,0,doNothing, noEvent, wrapStyle)
  ,FIELD(openingAlarms[0].minute,"","",0,59,10,1,doNothing, noEvent, wrapStyle)
);
...
MENU(closingMode,"Schliess Modus",showEvent,anyEvent,noStyle
  ,SUBMENU(chooseClosingMode)
  ,SUBMENU(dailySame)
  ,EDIT("Montag: ", bufTime, timeVal, doNothing, noEvent, noStyle)
  ,EDIT("Dienstag", bufTime, timeVal, doNothing, noEvent, noStyle)
  ,altOP(altPrompt,"",showEvent,anyEvent)
  ,EXIT("<Back")
);
...
MENU(mainMenu,"Main menu",doNothing,noEvent,wrapStyle
  ,SUBMENU(timeMenu)
  ,SUBMENU(dateMenu)
  ,SUBMENU(openingAlarmMenu)


  //,EDIT("Time", bufTime, timeVal, doNothing, noEvent, noStyle)
  //,OP("\xEF" "ffnungs Modus",action1,anyEvent)
  ,SUBMENU(closingMode)
  ,FIELD(brightness,"LUX:","",0,59,10,1,doNothing, noEvent, wrapStyle)

  ,OP("Datum ",action1,enterEvent)
  ,OP("Sprache ",action1,enterEvent)
  ,OP("Reset",doNothing,enterEvent)
  ,EXIT("<Zurueck")
